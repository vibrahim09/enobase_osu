(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_289c31._.js", {
...
_s(useLocalStorage, "U3BxgfGKfvc5AyBbhYzqUu2jZl4=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLocalStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/useLocalStorage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ClientOnly$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/ClientOnly.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$variable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__LucideVariable$3e$__ = __turbopack_import__("[project]/node_modules/lucide-react/dist/esm/icons/variable.js [app-client] (ecmascript) <export default as LucideVariable>");
...
;
;
const Variable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_require__("[project]/src/components/Variable.tsx [app-client] (ecmascript, async loader)")(__turbopack_import__).then((mod)=>mod.Variable), {
    loadableGenerated: {
        modules: [
            "src/components/Canvas.tsx -> " + "@/components/Variable"
        ]
    },
    ssr: false
});
_c = Variable;
const FormulaEngine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_require__("[project]/src/components/FormulaEngine.tsx [app-client] (ecmascript, async loader)")(__turbopack_import__).then((mod)=>mod.FormulaEngine), {
    loadableGenerated: {
        modules: [
            "src/components/Canvas.tsx -> " + "@/components/FormulaEngine"
        ]
    },
    ssr: false
});
...
function Canvas() {
    _s();
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLocalStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])('canvas-items', []);
    ...
    const [ignoreNextClick, setIgnoreNextClick] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleCanvasClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[handleCanvasClick]": (e)=>{
            if (ignoreNextClick) {
    ...
    const handleMenuClose = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[handleMenuClose]": ()=>{
            setMenuPosition(null);
        }
    }["Canvas.useCallback[handleMenuClose]"], []);
    const handleEditingEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[handleEditingEnd]": ()=>{
            setIgnoreNextClick(true);
        }
    }["Canvas.useCallback[handleEditingEnd]"], []);
    const updateItemPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[updateItemPosition]": (id, position)=>{
            setItems({
                "Canvas.useCallback[updateItemPosition]": (prevItems)=>prevItems.map({
                        "Canvas.useCallback[updateItemPosition]": (item)=>item.id === id ? {
                                ...item,
                                position
                            } : item
                    }["Canvas.useCallback[updateItemPosition]"])
            }["Canvas.useCallback[updateItemPosition]"]);
        }
    }["Canvas.useCallback[updateItemPosition]"], [
        setItems
    ...
    const updateItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[updateItem]": (id, updates)=>{
            setItems({
                "Canvas.useCallback[updateItem]": (prevItems)=>{
                    const newItems = [
                        ...prevItems
                    ];
                    const itemIndex = newItems.findIndex({
                        "Canvas.useCallback[updateItem].itemIndex": (item)=>item.id === id
                    }["Canvas.useCallback[updateItem].itemIndex"]);
                    if (itemIndex !== -1) {
                        ...
                        if (updates.linkedVariable) {
                            const linkedVarIndex = newItems.findIndex({
                                "Canvas.useCallback[updateItem].linkedVarIndex": (item)=>item.id === updates.linkedVariable?.id
                            }["Canvas.useCallback[updateItem].linkedVarIndex"]);
                            if (linkedVarIndex !== -1) {
                                // Update existing linked variable
                                newItems[linkedVarIndex] = {
            ...
            }["Canvas.useCallback[updateItem]"]);
        }
    }["Canvas.useCallback[updateItem]"], [
        setItems
    ]);
    const createVariable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[createVariable]": ()=>{
            if (!menuPosition) return;
            setItems({
                "Canvas.useCallback[createVariable]": (prevItems)=>[
                        ...prevItems,
                        {
                            id: `var-${Date.now()}`,
                            type: 'variable',
    ...
    const createFormula = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[createFormula]": ()=>{
            if (!menuPosition) return;
            setItems({
                "Canvas.useCallback[createFormula]": (prevItems)=>[
                        ...prevItems,
                        {
                            id: `formula-${Date.now()}`,
                            type: 'formula',
    ...
    const deleteItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Canvas.useCallback[deleteItem]": (id)=>{
            setItems({
                "Canvas.useCallback[deleteItem]": (prevItems)=>{
                    const itemToDelete = prevItems.find({
                        "Canvas.useCallback[deleteItem].itemToDelete": (item)=>item.id === id
                    }["Canvas.useCallback[deleteItem].itemToDelete"]);
                    if (itemToDelete?.type === 'formula') {
                        // Also delete the linked variable if it exists
                        return prevItems.filter({
                            "Canvas.useCallback[deleteItem]": (item)=>item.id !== id && item.id !== `linked-${id}`
                        }["Canvas.useCallback[deleteItem]"]);
                    }
                    return prevItems.filter({
                        "Canvas.useCallback[deleteItem]": (item)=>item.id !== id
                    }["Canvas.useCallback[deleteItem]"]);
                }
            }["Canvas.useCallback[deleteItem]"]);
        }
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ClientOnly$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClientOnly"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
                    fallback: null,
                    children: visibleItems.map((item)=>item.type === 'variable' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Variable, {
                            item: item,
                            ...
                            lineNumber: 132,
                            columnNumber: 15
                        }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormulaEngine, {
                            item: item,
            ...
            menuPosition && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenu"], {
                defaultOpen: true,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuContent"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$variable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__LucideVariable$3e$__["LucideVariable"], {}, void 0, false, {
                                        fileName: "[project]/src/components/Canvas.tsx",
                                        lineNumber: 165,
                                        columnNumber: 15
                                    }, this),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$square$2d$function$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FunctionSquare$3e$__["FunctionSquare"], {}, void 0, false, {
                                        fileName: "[project]/src/components/Canvas.tsx",
                                        lineNumber: 168,
                                        columnNumber: 15
                                    }, this),
...
_s(Canvas, "q/FeHRbJ2rnNXrQjlEtTDkHrlW0=", false, function() {
    return [
...
_c2 = Canvas;
var _c, _c1, _c2;
__turbopack_refresh__.register(_c, "Variable");
__turbopack_refresh__.register(_c1, "FormulaEngine");
__turbopack_refresh__.register(_c2, "Canvas");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Canvas$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/Canvas.tsx [app-client] (ecmascript)");
"use client";
;
;
function Home() {
...
//# sourceMappingURL=src_289c31._.js.map